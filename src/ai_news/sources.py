...
DEFAULT_SOURCES = (
    ...
    Source("Ars Technica AI", "https://arstechnica.com/ai/feed/", "global", 0.85),
    Source("The Verge AI", "https://www.theverge.com/rss/ai-artificial-intelligence/index.xml", "global", 0.8),
    Source("Wired AI", "https://www.wired.com/feed/tag/ai/latest/rss", "global", 0.85),
    Source("The Register AI", "https://www.theregister.com/software/ai_ml/headlines.atom", "global", 0.75),
    Source("NVIDIA", "https://blogs.nvidia.com/feed/", "global", 0.8),
